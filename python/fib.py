...
if __name__ == "__main__":
  ...
  parser.add_argument("-r", "--recursive", help="Rekursiver Fibonacci", action="store_true")
  parser.add_argument("-i", "--iterative", help="Iterativer Fibonacci", action="store_true")
